        ...
        <div class="hamburger" @click="toggleMobileMenu" :class="{open: isActive}">
            ...
            <ul class="mobile-menu">
                ...
                <li class="nav-billing">
                    <router-link class="nav-link link_name" :to="{ name: 'chatBox', params: { prompt: 'chat' }}"><i class="far fa-comment-dots" aria-hidden="true"></i>Chat</router-link>
                </li>
                <li class="nav-billing">
                ...
                <li class="nav-billing">
                    <router-link class="nav-link link_name" :to="{ name: 'documentsList'}"><i class="far fa-file" aria-hidden="true"></i>Chat Doc</router-link>
                </li>
                <li class="nav-billing">
                ...
                <li class="nav-billing" v-if="isAdmin">
                    <router-link class="nav-link link_name" :to="{ name: 'freeDocumentChatList'}"><i class="fa-solid fa-robot" aria-hidden="true"></i>Chatbot</router-link>
                </li>
                <li class="nav-billing">
                    <router-link class="nav-link link_name" :to="{ name: 'archive'}"><i class="fa fa-database" aria-hidden="true"></i>Project</router-link>
                </li>
                <li class="nav-billing">
                    <router-link class="nav-link link_name" :to="{ name: 'dashboard'}"><i class="fa fa-list-alt" aria-hidden="true"></i>Templates</router-link>
                </li>
