<template>
	<div class="chatbox-container">
        <chat-head :name="`Custom Chat List`"/>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mb-3" v-for="(model, i) in models" :key="i">
                        <div class="model-section">
                            <router-link class="model" :to="{ name: 'customChatBox', params: { prompt: model.slug.split('/')[2] }}">
...
export default {
    ...
    methods: {
        search() {
            this.$store.dispatch('models/get_custom_chat_search_models', this.term);
        },
    },
    mounted() {
        this.$store.dispatch('models/get_custom_chat_search_models');
    },
}
</script>