        ...
        <div class="chatbox-body-main">
            ...
            <div class="chatbox-body">
                ...
                <div class="editor-section python-suggestions-section" :class="{editorHide: isEditorOpen, borderRight: pageInfo.is_image_editor}">
                    ...
                    ></PinturaEditor>
                    <div class="python-suggestions mx-4 text-center" v-else-if="pageInfo.isPythonSuggestions">
                        <p class="suggestion-text-bold pt-4">Suggestions</p>
                            <div v-if="typing" class="loader-outer">
                        ...
                        <div v-if="!typing">
                            <ul class="p-0">
                                <li v-for="(suggestion, key) in suggestions" :key="key" 
                                    class="related-option py-2 flex fs-7" @click="handlePickedSuggestion(suggestion)">
