<template>
	<div class="chatbox-container document-container container">
        <div class="row head-title">
            <chat-head :name="`Fine Tune`" class="sm:col-6"/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 new-document">
                        <button class="btn btn-submit" @click="showModal = true">
                            <i class="fa fa-plus" aria-hidden="true" title="New"></i> 
                            <span class="d-sm-inline-block d-none">New</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <select class="form-control bg-white" v-model="chat_suite_id">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <textarea class="form-control bg-white" placeholder="Enter system message" row="2" v-model="system_msg"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn theme-btn mr-3" @click="submit()">Save</button>
